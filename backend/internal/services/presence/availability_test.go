...
func TestGoOnlineRejectsDriverWithoutActiveAssignment(t *testing.T) {
	...
	// ---------------------------------------------------------
	// 4. Create isolated driver presence.
	// ---------------------------------------------------------
	...
	// ---------------------------------------------------------
	// 6. Preserve isolated driver's presence state.
	// ---------------------------------------------------------
	...
	// ---------------------------------------------------------
	// 8. Close the isolated driver's assignment.
	//
...
func TestGoOnlineRejectsMissingPresenceRow(t *testing.T) {
	...
	// ---------------------------------------------------------
	// 3. Create isolated driver fixture.
	// ---------------------------------------------------------
	...
	// ---------------------------------------------------------
	// 4. Confirm isolated driver has an active assignment.
	//
	// This proves GoOnline fails because presence is missing,
	// not because the assignment is missing.
	// ---------------------------------------------------------
	...
	// ---------------------------------------------------------
	// 5. Create an isolated presence row.
	//
	// The test will deliberately delete this row before calling
	// GoOnline.
	// ---------------------------------------------------------
	...
	// ---------------------------------------------------------
	// 6. Delete the isolated driver's presence row.
	// ---------------------------------------------------------
...
func TestGoOfflineRejectsMissingPresenceRow(t *testing.T) {
	ctx := context.Background()
	...
	// ---------------------------------------------------------
	// 4. Preserve the COMPLETE driver_presence row.
	// ---------------------------------------------------------
	...
	// ---------------------------------------------------------
	// 5. Always restore the deleted presence row.
	// ---------------------------------------------------------
	...
	// ---------------------------------------------------------
	// 6. Temporarily delete John's presence row.
	// ---------------------------------------------------------
	...
	if err != nil {
		t.Fatalf(
			"delete driver presence for GoOffline test: %v",
			err,
		)
	}
	...
	// ---------------------------------------------------------
	// 7. Construct the real transactional presence service.
	// ---------------------------------------------------------
	...
	// ---------------------------------------------------------
	// 8. GoOffline must distinguish missing presence from a
	//    BUSY/active-trip lifecycle conflict.
	// ---------------------------------------------------------
	...
	// ---------------------------------------------------------
	// 9. GoOffline must not recreate presence implicitly.
	// ---------------------------------------------------------
...
func TestHeartbeatRejectsMissingPresenceRow(t *testing.T) {
	ctx := context.Background()
	...
	// 4. Preserve the COMPLETE driver_presence row.
	//
	// Heartbeat must not recreate a missing presence row, so
	// this shared fixture is temporarily removed and restored
	// after the assertion.
	// ---------------------------------------------------------
	...
	if err != nil {
		t.Fatalf(
			"delete driver presence for heartbeat test: %v",
			err,
		)
	}
	...
	// ---------------------------------------------------------
	// 8. Attempt heartbeat with valid telemetry.
	//
	// The telemetry itself is intentionally valid so the test
	// reaches the presence-row lifecycle check.
	// ---------------------------------------------------------
	...
	// ---------------------------------------------------------
	// 9. Missing presence has a precise domain meaning.
	//
	// It must not be collapsed into
	// ErrDriverHeartbeatUnavailable, which represents an
	// existing presence row that is not heartbeat-eligible.
	// ---------------------------------------------------------
	...
	if errors.Is(
		...
		t.Fatalf(
			"expected missing presence not to be reported as ErrDriverHeartbeatUnavailable",
		)
	}

	// ---------------------------------------------------------
	// 10. Heartbeat must never recreate lifecycle state.
	// ---------------------------------------------------------
	...
	if err := db.QueryRow(
		...
		t.Fatalf(
			"count driver presence after rejected heartbeat: %v",
			err,
		)
	}
	...
	if presenceCount != 0 {
		t.Fatalf(
			"expected heartbeat not to recreate missing presence row, found %d row(s)",
			presenceCount,
		)
	}
}
